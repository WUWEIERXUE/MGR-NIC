...
beta=2;
  %%% MGR-NIC  
tic;
[P,S,B,F,hH,err1]=clustering_mgrNIC(XX,M,k,k2,alpha,lamta,beta); 
toc;
%%% Call the main function to solve the variables
%%% 
...
result1= ClusteringMeasure_new(true_label,prel);
